...
//
// The design it serves (facts §32.4): the game is handed REPLACEMENT back buffers through a
...
// ---- the game's back-buffer index, mirrored (facts §32.4, HARD from UE 4.27.2 source) ----
//
...
// ---- the camera constants DLSS-G takes (facts §32.2), from the View CB's matrices ----
namespace stray_dlss::core::fg {
