...
//   * ReShade's log  — the normal channel, but only available AFTER register_addon succeeds.
...
// Called once register_addon has succeeded, so messages also reach ReShade.log.
